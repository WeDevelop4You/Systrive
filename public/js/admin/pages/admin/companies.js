...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    dialogOpened: function dialogOpened() {
      if (!this.isEditing) {
        this.$store.dispatch("".concat(this.vuexNamespace, "/searchList"), '');
      }
    },
    save: function save() {
      var _this = this;
                        ...
                        directives: [
                          {
                            name: "can",
                            rawName: "v-can",
                            value: "user.edit_roles",
                            expression: "'user.edit_roles'",
                          },
                        ],
                        staticClass: "mr-2",
                        attrs: { small: "", disabled: _vm.$loading },
            ...
            scopedSlots: _vm._u([
              {
                ...
                fn: function (ref) {
                  ...
                  return [
                    _c("span", [
                      _vm._v(
                        _vm._s(item.full_name) + " (" + _vm._s(item.email) + ")"
                      ),
                    ]),
                  ]
                },
                    ...
                    _c(
                      ...
                      [
                        _c("v-list-item-title", {
                          domProps: { textContent: _vm._s(item.full_name) },
                        }),
                        _vm._v(" "),
            ...
            return [
              _c(
                "create-or-edit-dialog",
                {
                  ...
                  on: { save: _vm.save, open: _vm.dialogOpened },
                },
                [
                  _c("f-company", {
                    model: {
