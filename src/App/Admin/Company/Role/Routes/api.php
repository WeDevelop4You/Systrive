...
use App\Admin\Company\Role\Controllers\CompanyRoleTableController;
    ...
    Route::prefix('{company}/roles')->middleware('auth:sanctum')->group(function () {
        ...
        Route::prefix('create')->controller(CompanyRoleCreateController::class)->group(function () {
        ...
        Route::prefix('{role}')->scopeBindings()->group(function () {
            Route::prefix('edit')->controller(CompanyRoleEditController::class)->group(function () {
                Route::get('/', 'index')->name('company.role.edit');
                Route::patch('/', 'action')->name('company.role.edit');
            });

            Route::prefix('destroy')->controller(CompanyRoleDestroyController::class)->group(function () {
