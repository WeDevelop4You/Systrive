...
class WidthDimensionColumnOption extends AbstractColumnOption
{
    ...
    protected function requirements(FormRequest $request): Validations
    {
        return new Validations([
            "required_unless:{$this->getOtherFormKey('dimension_height')},null",
            'nullable',
            'integer',
            'min:1',
            new DimensionRule(
                $this->getOtherFormKey('dimension_height'),
